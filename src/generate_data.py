...
def get_or_generate_colleciton(name: str = "rating_over_time"):
...
def get_random_timestamp():
    ...
    delta = now - datetime.timedelta(
        days=random.randint(0, 5_000),
...
if __name__ == "__main__":
    ...
    try:
        ...
        pass
    collection = get_or_generate_colleciton(name=name)
